...
#
# Manipulates MRTd dumps, splicing one or more dumps together in time order, and
# outputting the result given start/end times, and given a certain 'chunk' size.
#
